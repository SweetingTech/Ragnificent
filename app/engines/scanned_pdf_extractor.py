...
Routes PDFs entirely through the configured OCR engine when they are known to
be scanned, or as configured.
"""
...
class ScannedPdfExtractor(Extractor):
    """Extractor for scanned PDF files using the configured OCR engine."""
